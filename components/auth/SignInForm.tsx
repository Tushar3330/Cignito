...
import { credentialsSignIn, githubSignIn, googleSignIn } from "@/app/lib/auth-actions";
...
export default function SignInForm() {
  ...
  useEffect(() => {
    ...
    if (errorParam === "OAuthAccountNotLinked") {
      setError("An account with this email already exists. Please sign in with your original method first.");
    }
  }, []);
